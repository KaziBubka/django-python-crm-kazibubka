...
# would most likely not want to store the value in the database but rather just make
# this a function we can run each time we load the customers' profile
# '''

# # (12)Returns the total count for number of times a "Ball" was ordered
# ballOrders = firstCustomer.order_set.filter(product__name="Ball")

# # (13)Returns total count for each product ordered
# allOrders = {}
